                    ...
                    <div className="social-section">
                        ...
                        <div className="">
                            <p className="footerDescription">
                                Copyright & &#169;{new Date().getFullYear()} Inc. NY, U.S. © All right Reversed <a className="text-green ml-2" href="http://realcheapny.com" target="blank"> translateApp@gmail.com</a>
                            </p>
                        </div>
